...
import 'package:ipark/Home3.dart';
import 'package:ipark/offering.dart';
import 'survey.dart';
...
class _HomeState extends State<Home2> {
  ...
  void _showMenu(BuildContext context) async {
    ...
    final List<PopupMenuItem<String>> items = [
      ...
      PopupMenuItem<String>(
        value: 'offers',  // Added 'offers' option
        child: Container(
          decoration: BoxDecoration(
            color: Colors.amber,
            border: Border.all(color: Colors.amber),
          ...
          child: ListTile(
            leading: Icon(Icons.local_offer, color: Colors.black),  // Icon for 'offers'
            title: Text(
              'View Offers',
              style: TextStyle(color: Colors.black),
            ),
  ...
  void _showPrice() {
    ...
    double pricePerMonth = 40.0; // Replace with your logic to get the actual price per month
    ...
    return MaterialApp(
      home: Scaffold(
        ...
        bottomNavigationBar: BottomAppBar(
          color: Colors.amber, // Change the color of the bottom navigation bar to black
          child: Container(
            height: 50.0,
            child: Row(
